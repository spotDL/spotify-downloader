...
def order_results(
    ...
    """
    links_with_match_value: dict[DownloadResult, float] = {}
    ...
    for result in results:
        ...
        if (
            average_match <= HIGH_MATCH_THRESHOLD
...
def get_best_matches(
    results: dict[DownloadResult, float], score_threshold: float = 5.0
) -> list[tuple[DownloadResult, float]]:
    """
...
) -> tuple[DownloadResult, float] | None:
    """

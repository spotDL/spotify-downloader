...
function AdminImportPage() {
  ...
  const handleClearCache = async (cacheType: "all" | "search" | "entities" | "matches") => {
    try {
      await clearCacheMutation.mutateAsync({ cache_type: cacheType });
      addToast(`${cacheType === "all" ? "All caches" : `${cacheType} cache`} cleared successfully`, "success");
    } catch (err) {
    ...
    <div className="space-y-6 animate-slide-up">
      ...
      <div>
        ...
        <p className="text-zinc-400 mt-1">
          Manage data and cache operations
        </p>
      </div>
      ...
      <Card variant="bordered">
        ...
        <CardContent>
          <p className="text-sm text-zinc-400 mb-4">
            Clear cached data to force fresh lookups. This is useful when debugging or after database changes.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Button
              ...
              className="justify-start"
            >
              <svg className="w-4 h-4 mr-2 text-accent-cool" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <Card variant="bordered">
        ...
        <CardContent>
          <p className="text-sm text-zinc-400 mb-4">
            Export data for backup or migration purposes.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card variant="bordered" className="bg-bg-panel/50">
              <CardContent className="py-4">
                <h4 className="font-medium text-zinc-200 mb-1">Matches Export</h4>
                <p className="text-sm text-zinc-500 mb-3">
                  Export all verified matches as JSON
                </p>
            ...
            <Card variant="bordered" className="bg-bg-panel/50">
              <CardContent className="py-4">
                <h4 className="font-medium text-zinc-200 mb-1">Statistics Export</h4>
                <p className="text-sm text-zinc-500 mb-3">
      ...
      <Card variant="bordered">
        ...
        <CardContent>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card variant="bordered" className="bg-bg-panel/50">
              <CardContent className="py-4">
                <h4 className="font-medium text-zinc-200 mb-1">Matches Import</h4>
                <p className="text-sm text-zinc-500 mb-3">
            ...
            <Card variant="bordered" className="bg-bg-panel/50">
              <CardContent className="py-4">
                <h4 className="font-medium text-zinc-200 mb-1">Bulk URL Import</h4>
                <p className="text-sm text-zinc-500 mb-3">
            ...
            <Card variant="bordered" className="bg-bg-panel/50">
              <CardContent className="py-4">
                <h4 className="font-medium text-zinc-200 mb-1">Database Restore</h4>
                <p className="text-sm text-zinc-500 mb-3">
      ...
      <Card variant="bordered" className="border-accent-peak/30">
        ...
        <CardContent>
          ...
          <div className="flex flex-wrap gap-4">
            <Button variant="outline" disabled className="border-accent-peak/30 text-accent-peak hover:bg-accent-peak/10">

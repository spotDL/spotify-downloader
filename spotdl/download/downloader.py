    ...
    async def download_song(self, songObj: SongObj) -> None:
        ...
        try:
            ...
            if exists(convertedFilePath):
                if progressTracker:
                    progressTracker.notify_download_skip()
            ...
            if progressTracker:
                progressTracker.notify_youtube_download_completion()
            ...
            if progressTracker:
                progressTracker.notify_conversion_completion()
            ...
            if progressTracker:
                progressTracker.notify_download_completion()

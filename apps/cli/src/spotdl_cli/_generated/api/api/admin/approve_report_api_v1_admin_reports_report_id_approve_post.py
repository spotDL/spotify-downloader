...
from ...models.admin_review_request import AdminReviewRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/admin/reports/{report_id}/approve".format(
            report_id=report_id,
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        report_id (UUID):
        body (AdminReviewRequest): Body of ``POST /admin/reports/{id}/approve`` and
            ``.../reject``.
